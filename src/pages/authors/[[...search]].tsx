...
// GraphQL 쿼리 정의
const AUTHORS_PAGE_QUERY_GET_USERS_BY_SEARCH: DocumentNode = gql`
  query AuthorsPageQueryGetUsersBySearch(
    $first: Int,
    $search: String = "",
    $after: String,
...
const Page: FaustPage<SearchPageQueryGetUsersBySearchQuery> & { query?: DocumentNode; variables?: any } = (props) => {
...
// 명시적으로 DocumentNode 타입으로 할당
Page.query = AUTHORS_PAGE_QUERY_GET_USERS_BY_SEARCH
