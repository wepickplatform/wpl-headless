...
const PlayerContent: FC<PlayerContentProps> = ({
	...
	const renderLeft = () => {
		return (
			<div className="mr-2 flex flex-grow items-center overflow-hidden lg:flex-shrink-0 lg:basis-52">
				...
				>
					<div className="absolute start-0 z-0 h-10 w-10 flex-shrink-0 overflow-hidden rounded-full shadow sm:h-12 sm:w-12">
						<NcImage
	...
	const renderContentCenter = () => {
		return (
			<div className="flex max-w-xs flex-grow items-center justify-evenly text-neutral-500 xl:max-w-md dark:text-neutral-300">
	...
	const renderVolumn = () => {
		return (
			<div className="hidden items-center justify-end text-neutral-500 lg:flex dark:text-neutral-300">
				<button
					onClick={() => {
						if (!volume) {
	...
	return (
		<>
			<Transition
				as={'div'}
				className="- nc-google-shadow relative z-0 flex w-full flex-col bg-white px-2 sm:px-3 dark:bg-neutral-800"
			...
			>
				...
				<Transition
					className="z-0 flex h-16 justify-center border-t border-neutral-300 transition-all lg:hidden dark:border-neutral-700"
					enter="duration-150"
					enterFrom="-mb-16"
					enterTo="mb-0"
					leave="duration-150"
				...
				>
					<div className="flex max-w-xs flex-grow items-center justify-evenly text-neutral-500 sm:max-w-sm md:max-w-md dark:text-neutral-300">
